  ...
  it('converts vimeo.com url',
    inject([EmbedVideoService, DomSanitizer], (embedVideoService, sanitizer) => {
      ...
      expect(embedVideoService.embed('http://vimeo.com/19339941')).toEqual(
        sanitizer.bypassSecurityTrustHtml('<iframe src="//player.vimeo.com/video/19339941" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>')
      )
    }));
  ...
  it('converts youtube.com url',
    inject([EmbedVideoService, DomSanitizer], (embedVideoService, sanitizer) => {
      ...
      expect(embedVideoService.embed('https://www.youtube.com/watch?v=twE64AuqE9A')).toEqual(
        sanitizer.bypassSecurityTrustHtml('<iframe src="//www.youtube.com/embed/twE64AuqE9A" frameborder="0" allowfullscreen></iframe>')
      )
    }));
  ...
  it('converts youtu.be url',
    inject([EmbedVideoService, DomSanitizer], (embedVideoService, sanitizer) => {
      ...
      expect(embedVideoService.embed('http://youtu.be/9XeNNqeHVDw#aid=P-Do3JLm4A0')).toEqual(
        sanitizer.bypassSecurityTrustHtml('<iframe src="//www.youtube.com/embed/9XeNNqeHVDw" frameborder="0" allowfullscreen></iframe>')
      )
    }));
  ...
  it('converts dailymotion.com url',
    inject([EmbedVideoService, DomSanitizer], (embedVideoService, sanitizer) => {
      ...
      expect(embedVideoService.embed('https://www.dailymotion.com/video/x20qnej_red-bull-presents-wild-ride-bmx-mtb-dirt_sport')).toEqual(
        sanitizer.bypassSecurityTrustHtml('<iframe src="//www.dailymotion.com/embed/video/x20qnej" frameborder="0" allowfullscreen></iframe>')
      )
    }));
  ...
  it('accepts query param youtube',
    inject([EmbedVideoService, DomSanitizer], (embedVideoService, sanitizer) => {
      ...
      expect(embedVideoService.embed_youtube('9XeNNqeHVDw', { query: { rel: 0, showinfo: 0 } })).toEqual(
        sanitizer.bypassSecurityTrustHtml('<iframe src="//www.youtube.com/embed/9XeNNqeHVDw?rel=0&showinfo=0" frameborder="0" allowfullscreen></iframe>')
      )
    }));
  ...
  it('accepts attributes youtube',
    inject([EmbedVideoService, DomSanitizer], (embedVideoService, sanitizer) => {
      ...
      expect(embedVideoService.embed_youtube('9XeNNqeHVDw', { query: { rel: 0, showinfo: 0 }, attr: { width: 400, height: 200 } })).toEqual(
        sanitizer.bypassSecurityTrustHtml('<iframe src="//www.youtube.com/embed/9XeNNqeHVDw?rel=0&showinfo=0" width="400" height="200" frameborder="0" allowfullscreen></iframe>')
      )
    }));
  ...
  it('accepts query param vimeo',
    inject([EmbedVideoService, DomSanitizer], (embedVideoService, sanitizer) => {
      ...
      expect(embedVideoService.embed_vimeo('19339941', { query: { portrait: 0, color: '333' } })).toEqual(
        sanitizer.bypassSecurityTrustHtml('<iframe src="//player.vimeo.com/video/19339941?portrait=0&color=333" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>')
      )
    }));
  ...
  it('accepts attributes vimeo',
    inject([EmbedVideoService, DomSanitizer], (embedVideoService, sanitizer) => {
      ...
      expect(embedVideoService.embed_vimeo('19339941', { query: { portrait: 0, color: '333' }, attr: { width: 400, height: 200 } })).toEqual(
        sanitizer.bypassSecurityTrustHtml('<iframe src="//player.vimeo.com/video/19339941?portrait=0&color=333" width="400" height="200" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>')
      )
    }));
  ...
  it('accepts query param dailymotion',
    inject([EmbedVideoService, DomSanitizer], (embedVideoService, sanitizer) => {
      ...
      expect(embedVideoService.embed_dailymotion('x20qnej', { query: { autoPlay: 1, start: 66 } })).toEqual(
        sanitizer.bypassSecurityTrustHtml('<iframe src="//www.dailymotion.com/embed/video/x20qnej?autoPlay=1&start=66" frameborder="0" allowfullscreen></iframe>')
      )
    }));
  ...
  it('accepts attributes dailymotion',
    inject([EmbedVideoService, DomSanitizer], (embedVideoService, sanitizer) => {
      ...
      expect(embedVideoService.embed_dailymotion('x20qnej', { query: { autoPlay: 1, start: 66 }, attr: { width: 400, height: 200 } })).toEqual(
        sanitizer.bypassSecurityTrustHtml('<iframe src="//www.dailymotion.com/embed/video/x20qnej?autoPlay=1&start=66" width="400" height="200" frameborder="0" allowfullscreen></iframe>')
      )
    }));
  ...
  it('gets youtube thumbnail (prove backwards compatibility)',
    async(inject([EmbedVideoService], (embedVideoService) => {
      ...
      embedVideoService.embed_image('https://youtu.be/ZeLnjXTNq6Q', { image: 'maxresdefault' }).then((image) => {
        expect(image.link).toEqual('//img.youtube.com/vi/ZeLnjXTNq6Q/maxresdefault.jpg');
        expect(image.html).toEqual('<img src="//img.youtube.com/vi/ZeLnjXTNq6Q/maxresdefault.jpg"/>');
      });
    })));
